...
![Startseite mit dem Anmeldeknopf](../bilder/web/web-01-anmeldeknopf.png)
...
![Anmeldeseite der Schule](../bilder/web/web-02-schulanmeldung.png)
...
![Zustimmung zum Zugriff auf das Schulkonto](../bilder/web/web-03-zustimmung.png)
...
=== "**Es gibt schon ein Handy oder einen anderen Rechner**"
    ...
    ??? tip   "Kein Gerät mehr zur Hand? Alternativ nimmt Element den **Wiederherstellungsschlüssel**"
        ...
        ![Wiederherstellungsschlüssel](../bilder/web/web_schluessel.png)
    ...
    ![Nachfrage nach dem Wiederherstellungsschlüssel](../bilder/web/web-04-schluessel.png)
    ...
    **Auf dem anderen Gerät** erscheint eine Nachfrage (Das kann ein paar Sekunden dauern) — bestätigen, und in beiden Fenstern erscheinen
    ...
    ![Verifizierung angefordert](../bilder/ex/ex-verifizierung-angefordert.png)

    ![Emojis](../bilder/ex/ex-emojis.png)

    </div>

    ![Emojis](../bilder/web/web_verifizierung.png)
...
![Suche mit dem Reiter „Personen"](../bilder/web/web-05-personen.png)
...
![Manage Accounts](../bilder/web/web-05-abmelden.png)

![Menü mit dem Eintrag „Abmelden"](../bilder/web/web-05-abmelden2.png)
